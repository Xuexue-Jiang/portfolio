...
var commentsUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-5BQDLPIV.js")
});
...
var structureUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources2-U3P4POZR.js")
});
...
var DocumentPaneProvider = (0, import_react2.memo)((props) => {
  ...
  ), focusPathRef = (0, import_react2.useRef)(focusPath), openPathRef = (0, import_react2.useRef)([]), activeViewId = params.view || views2[0] && views2[0].id || null, [timelineMode, setTimelineMode] = (0, import_react2.useState)("closed"), [timelineError, setTimelineError] = (0, import_react2.useState)(null), timelineStore = useTimelineStore({
    documentId,
    documentType,
  ...
  const setOpenPath = (0, import_react2.useCallback)(
    ...
    (blurredPath) => {
      disableBlurRef.current || (setFocusPath(EMPTY_ARRAY$b), setOpenPath(blurredPath), focusPathRef.current !== EMPTY_ARRAY$b && (focusPathRef.current = EMPTY_ARRAY$b, onFocusPath == null || onFocusPath(EMPTY_ARRAY$b)));
    },
...
var tasksUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources3-2QJC37SU.js")
});
    ...
    tools: [
      {
        ...
        icon,
        component: (0, import_react2.lazy)(() => import("./index3-UJJI7H74.js")),
...
//# sourceMappingURL=chunk-MUVYOARI.js.map
